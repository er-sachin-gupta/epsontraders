...
<head>
    ...
    <![endif]-->
    <!-- Meta Description -->
    <meta name="description" content="Apson Traders - selling New and Used Machines Products.">
    <!-- Meta Keyword -->
    ...
    <!-- Site Title -->
    <title>Apson Traders Products | Deals in selling of New and Used Machines | apsontraders.com</title>
...
<div id="wrapper" class="main-wrapper">
    ...
    <div class="container margin_bottom100">
        <div class="row">
